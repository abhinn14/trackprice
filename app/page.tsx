  ...
  const FEATURES = [
    {
      ...
      description:
        "Extract prices in seconds, even from JavaScript-heavy e-commerce sites.",
    },
    {
      icon: Shield,
      title: "Always Reliable",
      description:
        "Built to work across major platforms with smart scraping & retries.",
    },
    {
      icon: Bell,
      title: "Smart Alerts",
      description:
        "Get notified instantly when prices drop below your last check.",
    },
  ];
